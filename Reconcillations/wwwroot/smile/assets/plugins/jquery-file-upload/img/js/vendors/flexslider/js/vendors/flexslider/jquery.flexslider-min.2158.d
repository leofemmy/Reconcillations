...
<!-- Mirrored from radixtouch.in/templates/admin/smile/source/assets/plugins/jquery-file-upload/img/js/vendors/flexslider/js/vendors/flexslider/jquery.flexslider-min.js by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 02 Aug 2018 10:41:34 GMT -->
<head>
...
<!-- Favicon -->
<link rel="shortcut icon" href="imag/redixtouch.160d3.delaye" type="image/x-icon">
<link rel="icon" href="imag/redixtouch.160d3.delaye" type="image/x-icon">

<!-- FontsOnline -->
<link href='https://fonts.googleapis.com/css?family=Roboto:400,500,700,900,300,100' rel='stylesheet' type='text/css'>

<!-- StyleSheets -->
<link rel="stylesheet" href="css/ionicons.min.160d4.delay">
<link rel="stylesheet" href="css/materialize.min.160d5.de">
<link rel="stylesheet" href="css//bootstrap.min.160d6.del">
<link rel="stylesheet" href="css/font-awesome.min.160d7.d">
<link rel="stylesheet" href="css/main.css">
<link rel="stylesheet" href="css/style.css">
<link rel="stylesheet" href="css/responsive.css">

<!-- SLIDER REVOLUTION 4.x CSS SETTINGS -->
<link rel="stylesheet" type="text/css" href="rs-plu/settings.160db.delaye" media="screen" />

<!-- JavaScripts -->
<script src="js/ve/modernizr.160dc.delaye"></script>
        ...
        <nav>
          <ul id="ownmenu" class="ownmenu">
            ...
            <li><a href="services">SERVICES</a> 
            	<ul class="dropdown">
            		<li><a href="website-development.160e1.de">Website Development</a> </li>
            		<li><a href="java-development.160e2.delay">java Development</a> </li>
            		<li><a href="html-development.160e3.delay">html 5 Development </a> </li>
            		<li><a href="responsive-webdesign.160e4.d">Responsive webdesign</a> </li>
            		<li><a href="website-redesign.160e5.delay">website redesign</a> </li>
            		<li><a href="ecommerce-solution.160e6.del">ecommerce solution</a> </li>
            	</ul>
            </li>
      ...
      <div class="tp-banner-fix ">
        <ul>
          ...
          <li data-transition="random" data-slotamount="7"> 
            <!-- MAIN IMAGE --> 
            <img src="images/slides/1.160e9.delaye"  alt=""  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat"> 
            
          </li>
          
          <li data-transition="random" data-slotamount="7"> 
            <!-- MAIN IMAGE --> 
            <img src="images/slides/2.160ea.delaye"  alt=""  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat"> 

          </li>
          
          <li data-transition="random" data-slotamount="7"> 
            <!-- MAIN IMAGE --> 
            <img src="images/slides/3.160eb.delaye"  alt=""  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat"> 
            
          </li>
          
          <li data-transition="random" data-slotamount="7"> 
            <!-- MAIN IMAGE --> 
            <img src="images/slides/4.160ec.delaye"  alt=""  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat"> 
            
          </li>
          
          <li data-transition="random" data-slotamount="7"> 
            <!-- MAIN IMAGE --> 
            <img src="images/slides/5.160ed.delaye"  alt=""  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat"> 
            <!-- LAYERS --> 
    ...
    <section class="welcome padding-top-100 padding-bottom-100 ">
      <div class="container"> 
        ...
        <div class="row">
          ...
          <div class="col-md-5"> <img class="img-responsive" src="imag/intro-tabs.160ee.delaye" alt="" > </div>
        </div>
      </div>
    </section>
    ...
    <section class="portfolio port-wrap pink-bg padding-top-80">
      ...
      <div class="items row col-4"> 
        ...
        <article class="portfolio-item pf-web-design">
          <div class="portfolio-image"> <img class="img-responsive" alt="Open Imagination" src="images/po/img-1.160ef.delaye"> <a href="images/po/img-1.160ef.delaye" data-rel="prettyPhoto" class="prettyPhoto lightzoom zoom"><i class="ion-ios-search"></i></a>
        ...
        <article class="portfolio-item pf-branding-design">
          <div class="portfolio-image"> <img class="img-responsive" alt="Open Imagination" src="images/po/img-2.160f1.delaye"> <a href="images/po/img-2.160f1.delaye" data-rel="prettyPhoto" class="prettyPhoto lightzoom zoom"><i class="ion-ios-search"></i></a>
            <div class="portfolio-overlay style-2">
              <div class="detail-info">
                <h3><a href="pf-w-admin-panel.160f2.delay">Admin Panel</a></h3>
                <span><a href="pf-w-admin-panel.160f2.delay">Wed Design</a></span> </div>
            </div>
          </div>
        </article>
        ...
        <!-- ITEM -->
        <article class="portfolio-item pf-web-design">
          <div class="portfolio-image"> <img class="img-responsive" alt="Open Imagination" src="images/po/img-3.160f3.delaye"> <a href="images/po/img-3.160f3.delaye" data-rel="prettyPhoto" class="prettyPhoto lightzoom zoom"><i class="ion-ios-search"></i></a>
            <div class="portfolio-overlay style-2">
              <div class="detail-info">
        ...
        <!-- ITEM -->
        <article class="portfolio-item pf-branding-design">
          <div class="portfolio-image"> <img class="img-responsive" alt="Open Imagination" src="images/po/img-4.160f5.delaye"> <a href="images/po/img-4.160f5.delaye" data-rel="prettyPhoto" class="prettyPhoto lightzoom zoom"><i class="ion-ios-search"></i></a>
            <div class="portfolio-overlay style-2">
              <div class="detail-info">
                <h3><a href="portfolio-single.160f6.delay">Boulangerie product design</a></h3>
                <span><a href="portfolio-single.160f6.delay">Branding &amp; Wed Design</a></span> </div>
            </div>
          </div>
        </article>
    ...
    <section class="why-choose padding-top-100 padding-bottom-100">
      <div class="container"> 
        ...
        <div class="row">
          ...
          <div class="col-md-5 text-bold"> <img class="img-responsive" src="imag/why-choose-img.160f7.de" alt="" > </div>
        </div>
      </div>
    </section>
...
<!-- JavaScripts --> 
<script src="js/v/jquery.min.160f8.delaye"></script> 
<script src="js/vend/wow.min.160f9.delaye"></script> 
<script src="js/v/bootstrap.min.160fa.del"></script> 
<script src="js/v/materialize.min.160fb.d"></script> 
<script src="js/ven/own-menu.160fc.delaye"></script> 
<script src="js/v/jquery.prettyPhoto.160f"></script> 
<script src="js/v/jquery.flexslider-min.1"></script> 
<script src="js/v/jquery.isotope.min.160f"></script> 
<script src="js/v/owl.carousel.min.16100"></script> 

<!-- SLIDER REVOLUTION 4.x SCRIPTS  --> 
<script type="text/javascript" src="rs-p/jquery.themepunch.tools"></script> 
<script type="text/javascript" src="rs-p/jquery.themepunch.revol"></script> 
<script src="js/main.js"></script>

</body>

<!-- Mirrored from radixtouch.in/templates/admin/smile/source/assets/plugins/jquery-file-upload/img/js/vendors/flexslider/js/vendors/flexslider/jquery.flexslider-min.js by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 02 Aug 2018 10:41:35 GMT -->
</html>