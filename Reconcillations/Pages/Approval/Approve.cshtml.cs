...
namespace Reconcillations.Pages.Approval
{
    public class ApproveModel : PageModel
    {
        ...
        [BindProperty]
        public List<Requesntsent> _translist
        {
            get; set;
        }


        public ApproveModel(IHostEnvironment hostingEnvironment, ITransactionRepository transactionRepository, IEmailSender emailSender)
        {
